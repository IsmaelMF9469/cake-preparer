...
var fatias = Number(prompt('Digite a quantidado de fatias do bolo: '));
...
bolo.fatiar(fatias);
console.log("Bolo de ".concat(sabor, " com ").concat(recheio, ": R$ ").concat(valor, " e ainda restam ").concat(fatias, " fatias"));
